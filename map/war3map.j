...
function C_Unit takes unit u returns integer
...
function Filter_0 takes nothing returns boolean
    local integer u= C_Unit(GetTriggerUnit())
...
function TestClassUnit takes nothing returns nothing
    ...
    loop
        ...
        call DisplayTextToPlayer(Player(0), 0, 0, ("[" + I2S(i) + "] Index(head:" + I2S(C_Unit_g_instance_pointer_head) + "/tail:" + I2S(C_Unit_g_instance_pointer_tail) + "/size:" + I2S(C_Unit_g_instances_length) + ")")) // INLINED!!
        set i=i + 1
    endloop
